...
namespace Dan_Daniela_Proiect_App.Data
{
    public class RestApi : IRestApi
    {
        ...
        string RestUrl = "https://192.168.1.17:45455/swagger{0}";
        public List<ShoePage> Items { get; private set; }
        public RestApi()
        {
        ...
        public async Task<List<ShoePage>> RefreshDataAsync()
        {
            Items = new List<ShoePage>();
            ...
            try
            {
                ...
                if (response.IsSuccessStatusCode)
                {
                    ...
                    Items = JsonConvert.DeserializeObject<List<ShoePage>>(content);
                }
            }
            catch (Exception ex)
            {
        ...
        public async Task SaveShoePageAsync(ShoePage item, bool isNewItem = true)
        {
            Uri uri = new Uri(string.Format(RestUrl, string.Empty));
            try
            {
        ...
        public async Task DeleteShoePageAsync(int id)
        {
